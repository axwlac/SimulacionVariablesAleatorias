...
### Densidades
## Exp(lambda)
Para simular una exponencial de parametro lambda se requiere simular un número aleatorio con runif, definir la función de parametros n y lambda. Como la Fd de una exp es $$1-exp(-l)=u$$ si despejamos obtenemos $$l=-log(1-u)$$ lo cual es lo que necesitamos para simulkar una exponencial. 
```{r}
set.seed(315197444)
library(ggplot2)
library(purrr)
